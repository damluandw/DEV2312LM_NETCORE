...
namespace DanhGiaRenLuyen_V2.Areas.Admins.Controllers
{
    ...
    public class AnswersController : Controller
    {
        ...
        {
            ViewData["QuestionId"] = new SelectList(_context.Questions, "Id", "ContentQuestion");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,QuestionId,ContentAnswer,AnswerScore")] Answer answer)
        {
            if (id != answer.Id)
            {
                return NotFound();
