...
namespace DanhGiaRenLuyen_V2.Areas.Admins.Controllers
{
    ...
    public class RolesController : Controller
    {
        ...
        public RolesController(DanhGiaRenLuyenContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,RoleName,IsActive")] Role role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RoleName,IsActive")] Role role)
        {
            if (id != role.Id)
            {
                return NotFound();
