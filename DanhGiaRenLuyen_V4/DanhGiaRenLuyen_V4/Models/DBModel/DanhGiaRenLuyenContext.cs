...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AccountA__3214EC074E8AB606");

            entity.ToTable("AccountAdmin");

            entity.HasIndex(e => e.UserName, "UQ__AccountA__C9F2845674E24E10").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AccountL__3214EC074B2D1C19");

            entity.ToTable("AccountLecturer");

            entity.HasIndex(e => e.UserName, "UQ__AccountL__C9F28456945DFD08").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AccountS__3214EC07BC976F8B");

            entity.ToTable("AccountStudent");

            entity.HasIndex(e => e.UserName, "UQ__AccountS__C9F2845680FFFBC6").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AnswerLi__3214EC07FEE9CB37");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Class__3214EC071EE0010B");

            entity.ToTable("Class");

            entity.HasIndex(e => e.Name, "UQ__Class__737584F6C59CD669").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ClassAns__3214EC07EABEE82B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Classify__3214EC0772484CF0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Course__3214EC073247CD83");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Departme__3214EC077DE73888");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__GroupQue__3214EC07C6AA319F");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Lecturer__3214EC074CD6B852");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Position__3214EC07B7147747");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Question__3214EC075C1B2FA6");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Question__3214EC074103D2FE");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Roles__3214EC07D5AD98F7");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SelfAnsw__3214EC07CC738DFB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Semester__3214EC074D3E0D8E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Student__3214EC0737926A75");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SumaryOf__3214EC071FF8758E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__TypeQues__3214EC07B77F4C64");
