...
namespace NETCore_Lesson06.Models;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-TIMF1MA\\SQLEXPRESS;Database=BookStore;Trusted_Connection=True; MultipleActiveResultSets=True; TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A6AF1C9D9D");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C2077FA2910A");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0B08EE20A0");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCF0590E5C3");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36CFB29AD19");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FABE6DF4008");
