...
PositionId INT FOREIGN KEY (POSITIONId)REFERENCES POSITION(Id),
IsActive TINYINT ,
IsDelete BIT ,)
...
(N'Lớp trưởng',1),
(N'Thư ký khoa',2),
(N'Giảng viên cơ hữu',2),
(N'Giảng viên thỉnh giảng',2),
(N'Phó trưởng khoa',2),
(N'Trưởng khoa',2)
INSERT INTO  LECTURER VALUES
('GV00000001',N'Đàm Luận','KS',1,3,'19970917','luan.dv@ntu-hn.edu.vn','0976897563',1,0,0)
...
('2110900054',N'Nguyễn Ngọc Việt','20030813','','',0,1,2,1,0),
('2110900009',N'Đặng Trần Đức','20030802','','',0,1,1,1,0),
('2110900025',N'Lê Đình Hùng','20030209','','',0,1,1,1,0),
('2110900052',N'Nguyễn Mạnh Hùng','20030807','','',0,1,1,1,0),
('2110900037',N'Nguyễn Tuấn Tài','20030711','','',0,1,1,1,0)
