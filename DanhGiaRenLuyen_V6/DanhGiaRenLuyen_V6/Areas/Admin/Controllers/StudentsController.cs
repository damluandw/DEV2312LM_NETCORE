...
namespace DanhGiaRenLuyen_V6.Areas.Admin.Controllers
{
    public class StudentsController : BaseController
    {
        ...
        public IActionResult Create(int? departmentId)
        {
            ...
            ViewData["PositionId"] = new SelectList(_context.Positions.Where(x => x.Status == PositionConstants.CanBoLop), "Id", "Name");
            ViewBag.DepartmentId = departmentId;
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Birthday,Email,Phone,Gender,ClassId,PositionId,IsActive")] Students student, int?departmentId)
        {
            ...
            ViewData["PositionId"] = new SelectList(_context.Positions.Where(x => x.Status == PositionConstants.CanBoLop), "Id", "Name", student.PositionId);
            return View(student);
        }
