    ...
    public class DepartmentsController : BaseController
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Departments != null ? 
                          ...
                          Problem("Entity set 'DanhGiaRenLuyenContext.Departments'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Times")] Department department)
        {
            if (id != department.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DanhGiaRenLuyenContext.Departments'  is null.");
            }
            var department = await _context.Departments.FindAsync(id);
            if (department != null)
            {
