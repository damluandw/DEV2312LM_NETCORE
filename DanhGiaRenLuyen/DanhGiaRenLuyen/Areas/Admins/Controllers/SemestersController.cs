    ...
    public class SemestersController : BaseController
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Semesters != null ? 
                          ...
                          Problem("Entity set 'DanhGiaRenLuyenContext.Semesters'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Semester1,SchoolYear,DateOpenStudent,DateEndStudent,DateEndClass,DateEndLecturer,Isactive")] Semester semester)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Semester1,SchoolYear,DateOpenStudent,DateEndStudent,DateEndClass,DateEndLecturer,Isactive")] Semester semester)
        {
            if (id != semester.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DanhGiaRenLuyenContext.Semesters'  is null.");
            }
            var semester = await _context.Semesters.FindAsync(id);
            if (semester != null)
            {
