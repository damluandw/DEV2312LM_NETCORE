...
namespace NETCore_Lesson07_LabTuLam.Areas.Admin.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(DbLab7Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categories != null ? 
                          ...
                          Problem("Entity set 'DbLab7Context.Categories'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbLab7Context.Categories'  is null.");
            }
            var category = await _context.Categories.FindAsync(id);
            if (category != null)
            {
