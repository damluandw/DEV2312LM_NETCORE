...
namespace NETCore_Lesson07_LabTuLam.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(DbLab7Context context)
        {
            _context = context;
        }
        ...
        {
            var dbLab7Context = _context.Products.Include(p => p.IdNavigation);
            return View(await dbLab7Context.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,SalePrice,Status,Categoryid,Createdate,Image,Description")] Product product)
        {
            ...
            ViewData["Id"] = new SelectList(_context.Categories, "Id", "Id", product.Id);
            return View(product);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbLab7Context.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
