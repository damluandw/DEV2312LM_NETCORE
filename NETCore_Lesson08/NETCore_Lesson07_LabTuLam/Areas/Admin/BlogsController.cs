...
namespace NETCore_Lesson07_LabTuLam.Areas.Admin
{
    [Area("Admin")]
    public class BlogsController : Controller
    {
        ...
        public BlogsController(DbLab7Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Blogs != null ? 
                          ...
                          Problem("Entity set 'DbLab7Context.Blogs'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbLab7Context.Blogs'  is null.");
            }
            var blog = await _context.Blogs.FindAsync(id);
            if (blog != null)
            {
