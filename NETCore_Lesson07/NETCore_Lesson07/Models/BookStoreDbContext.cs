...
//        => optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS; Database=BookStoreDB;Trusted_Connection=True; MultipleActiveResultSets=True; TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A69DC9C2C2");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C207F20EE6C4");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0BC89AFBC9");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCF3F559616");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36C2A7802B2");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FABF9252653");
